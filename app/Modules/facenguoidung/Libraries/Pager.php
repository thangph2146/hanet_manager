...
namespace App\Modules\facenguoidung\Libraries;

/**
 * Lớp Pager - cung cấp chức năng phân trang cho module FaceNguoiDung
 * 
 * Lớp này thay thế cho \CodeIgniter\Pager\Pager mặc định để tùy chỉnh
 * cách hiển thị và xử lý phân trang riêng cho module FaceNguoiDung.
 */
class Pager
{
    /**
