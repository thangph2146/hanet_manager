...
namespace App\Modules\dangkysukien\Controllers;
...
use App\Modules\dangkysukien\Traits\ExportTrait;
use App\Modules\dangkysukien\Traits\RelationTrait;

class DangKySuKien extends BaseController
{
    use ResponseTrait;
    use ExportTrait;
    use RelationTrait;
    ...
    protected $alert;
    protected $moduleUrl;
    protected $title = 'Đăng ký sự kiện';
    protected $module_name = 'dangkysukien';
    protected $controller_name = 'DangKySuKien';
    protected $primary_key = 'dangky_sukien_id';
    // Search
    protected $field_sort = 'ngay_dang_ky';
    protected $field_order = 'DESC';

    // Export
    protected $export_excel = 'danh_sach_dang_ky_su_kien_excel';
    protected $export_excel_title = 'DANH SÁCH ĐĂNG KÝ SỰ KIỆN (Excel)';

    protected $export_pdf = 'danh_sach_dang_ky_su_kien_pdf';
    protected $export_pdf_title = 'DANH SÁCH ĐĂNG KÝ SỰ KIỆN (PDF)';

    protected $export_excel_deleted = 'danh_sach_dang_ky_su_kien_da_xoa_excel';
    protected $export_excel_deleted_title = 'DANH SÁCH ĐĂNG KÝ SỰ KIỆN ĐÃ XÓA (Excel)';

    protected $export_pdf_deleted = 'danh_sach_dang_ky_su_kien_da_xoa_pdf';
    protected $export_pdf_deleted_title = 'DANH SÁCH ĐĂNG KÝ SỰ KIỆN ĐÃ XÓA (PDF)';
