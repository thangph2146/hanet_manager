...
namespace App\Modules\quanlydiengia\Controllers;
...
use App\Modules\quanlydiengia\Traits\ExportTrait;
use App\Modules\quanlydiengia\Traits\RelationTrait;

class Quanlydiengia extends BaseController
{
    use ResponseTrait;
    use ExportTrait;
    use RelationTrait;
    ...
    protected $module_name = 'quanlydiengia';
    protected $controller_name = 'Quanlydiengia';
