...
<?= $this->endSection() ?>
<?= $this->section('title') ?>THÙNG RÁC - FORM ĐĂNG KÝ SỰ KIỆN<?= $this->endSection() ?>

<?= $this->section('bread_cum_link') ?>
<?= view('components/_breakcrump', [
	'title' => 'Thùng rác - Form đăng ký sự kiện',
...
<div class="card shadow-sm">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Danh sách form đăng ký sự kiện đã xóa</h5>
        <div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 mb-2 mb-md-0">
                    <a href="<?= site_url($module_name) ?>" class="btn btn-outline-primary btn-sm">
                        <i class='bx bx-arrow-back'></i> Danh sách form đăng ký sự kiện
                    </a>
