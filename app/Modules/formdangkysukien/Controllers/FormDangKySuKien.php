...
namespace App\Modules\formdangkysukien\Controllers;

use App\Controllers\BaseController;
use App\Modules\formdangkysukien\Models\FormDangKySuKienModel;
...
class FormDangKySuKien extends BaseController
{
    use ResponseTrait;
    use ExportTrait;
    use RelationTrait;
    ...
    public function __construct()
    {
        ...
        $this->model = new FormDangKySuKienModel();
    ...
    public function update($id = null)
    {
        ...
        // Kiểm tra xem sự kiện đã thay đổi chưa (nếu có thay đổi)
        if (!empty($data['su_kien_id']) && $data['su_kien_id'] != $existingRecord->getSuKienId()) {
            // Có thể thêm xử lý kiểm tra riêng nếu cần
        }
