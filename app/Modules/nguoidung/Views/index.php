            ...
            try {
                ...
                if (userData && userData.id) {
                    ...
                    dataTable.rows().every(function() {
                        ...
                        if (rowId == userData.nguoi_dung_id) {
                            existingRow = this;
                    ...
                    if (existingRow) {
                        ...
                        var newRow = dataTable.row.add([
                            '<input type="checkbox" class="check-select-p" name="nguoi_dung_id[]" value="' + userData.nguoi_dung_id + '" />',
                            userData.AccountId,
                            userData.FullName,
                            '<span class="badge rounded-pill bg-success">Hoạt động</span>',
                            '<a href="<?= site_url('nguoidung/edit') ?>/' + userData.nguoi_dung_id + '" title="Edit ' + userData.FullName + '" class="btn btn-sm btn-primary"><i class="fadeIn animated bx bx-edit"></i></a> ' +
                            '<a href="<?= site_url('nguoidung/deleteusers') ?>/' + userData.nguoi_dung_id + '" title="Delete ' + userData.FullName + '" class="btn btn-sm btn-danger"><i class="lni lni-trash"></i></a>'
                        ]).draw(false).node();
