...
use App\Modules\khoahoc\Traits\ExportTrait;
use App\Modules\khoahoc\Traits\RelationTrait;
...
class KhoaHoc extends BaseController
{
    ...
    protected $moduleUrl;
    protected $title;
    protected $module_name = 'khoahoc';
    protected $controller_name = 'KhoaHoc';
    ...
    public function exportExcel()
    {
        $keyword = $this->request->getGet('keyword');
        $status = $this->request->getGet('status');
        $sort = $this->request->getGet('sort') ?? 'khoa_hoc_id';
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_khoa_hoc');
    }
    ...
    public function exportPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH KHÓA HỌC', 'danh_sach_khoa_hoc');
    }
    ...
    public function exportDeletedPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH KHÓA HỌC ĐÃ XÓA', 'danh_sach_khoa_hoc_da_xoa', true);
    }
    ...
    public function exportDeletedExcel()
    {
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_khoa_hoc_da_xoa', true);
    }
