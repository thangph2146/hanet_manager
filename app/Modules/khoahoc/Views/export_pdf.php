    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><?= $item->khoa_hoc_id ?></td>
                <td class="text-center"><?= $item->ten_khoa_hoc ?></td>
                <td class="text-center"><?= $item->nam_bat_dau ?></td>
                <td class="text-center"><?= $item->nam_ket_thuc ?></td>
                <td class="text-center"><?= $item->phong_khoa->ten_phong_khoa ?></td>
