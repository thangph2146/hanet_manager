...
use App\Modules\manhinh\Traits\ExportTrait;
use App\Modules\manhinh\Traits\RelationTrait;
...
class ManHinh extends BaseController
{
    ...
    protected $moduleUrl;
    protected $title;
    protected $module_name = 'manhinh';
    protected $controller_name = 'ManHinh';
    ...
    public function view($id = null)
    {
        ...
        if (empty($data)) {
            $this->alert->set('danger', 'Không tìm thấy dữ liệu màn hình', true);
            return redirect()->to($this->moduleUrl);
        }
    ...
    public function exportExcel()
    {
        $keyword = $this->request->getGet('keyword');
        $status = $this->request->getGet('status');
        $sort = $this->request->getGet('sort') ?? 'man_hinh_id';
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_man_hinh');
    }
    ...
    public function exportPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH MÀN HÌNH', 'danh_sach_man_hinh');
    }
    ...
    public function exportDeletedPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH MÀN HÌNH ĐÃ XÓA', 'danh_sach_man_hinh_da_xoa', true);
    }
    ...
    public function exportDeletedExcel()
    {
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_man_hinh_da_xoa', true);
    }
