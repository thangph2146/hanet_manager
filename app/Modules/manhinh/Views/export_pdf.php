    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><?= $item->getTenManHinh() ?></td>
                <td class="text-center"><?= $item->getMaManHinh() ?></td>
                <td class="text-center"><?= !empty($item->camera) ? $item->camera->getTenCamera() : 'N/A' ?></td>
                <td class="text-center"><?= !empty($item->template) ? $item->template->getTenTemplate() : 'N/A' ?></td>
