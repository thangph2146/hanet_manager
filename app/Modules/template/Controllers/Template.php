...
use App\Modules\template\Traits\ExportTrait;
use App\Modules\template\Traits\RelationTrait;
...
class Template extends BaseController
{
    ...
    public function exportExcel()
    {
        $keyword = $this->request->getGet('keyword');
        $status = $this->request->getGet('status');
        $sort = $this->request->getGet('sort') ?? 'template_id';
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_template');
    }
    ...
    public function exportPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH TEMPLATE', 'danh_sach_template');
    }
    ...
    public function exportDeletedPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH TEMPLATE ĐÃ XÓA', 'danh_sach_template_da_xoa', true);
    }
    ...
    public function exportDeletedExcel()
    {
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_template_da_xoa', true);
    }
