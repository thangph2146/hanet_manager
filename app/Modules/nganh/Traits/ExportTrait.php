...
trait ExportTrait
{
    ...
    protected function createExcelFile($data, $headers, $filters, $filename, $includeDeleted = false)
    {
        ...
        foreach ($data as $index => $item) {
            ...
            $sheet->setCellValue('B' . $row, $item->nganh_id);
            $sheet->setCellValue('C' . $row, $item->ten_nganh);
            $sheet->setCellValue('D' . $row, $item->ma_nganh);
            $sheet->setCellValue('E' . $row, !empty($item->phong_khoa) ? $item->phong_khoa->ten_phong_khoa : '');
