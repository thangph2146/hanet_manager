...
<?= $this->endSection() ?>
<?= $this->section('title') ?>CHI TIẾT CHECK-OUT SỰ KIỆN<?= $this->endSection() ?>

<?= $this->section('bread_cum_link') ?>
<?= view('components/_breakcrump', [
    'title' => 'Chi tiết check-out sự kiện',
...
<div class="card shadow-sm">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Chi tiết check-out sự kiện ID: <?= esc($data->getId()) ?></h5>
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($data->getThoiGianCheckOut()): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($data->getCheckoutType())): ?>
                                <span class="badge bg-info"><?= esc($data->getCheckoutTypeText()) ?></span>
                            <?php else: ?>
                                <span class="text-muted fst-italic">Chưa cập nhật</span>
                            <?php endif; ?>
                        </td>
                    ...
                    <?php if ($data->getCheckoutType() === 'face_id'): ?>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($data->getAttendanceDurationMinutes()): ?>
                                <?= esc($data->getAttendanceDurationFormatted()) ?>
                            <?php else: ?>
                                <span class="text-muted fst-italic">Chưa cập nhật</span>
                            <?php endif; ?>
                        </td>
                    ...
                    <tr>
                        <th>Đánh giá</th>
                        <td>
                            <?php if ($data->getDanhGia()): ?>
                                <div class="text-warning"><?= $data->getDanhGiaStars() ?></div>
                            <?php else: ?>
                                <span class="text-muted fst-italic">Chưa đánh giá</span>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($data->getNoiDungDanhGia())): ?>
                                <?= nl2br(esc($data->getNoiDungDanhGia())) ?>
                            <?php else: ?>
                                <span class="text-muted fst-italic">Chưa cập nhật</span>
                            <?php endif; ?>
                        </td>
                    ...
                    <tr>
                        <th>Phản hồi</th>
                        <td>
                            <?php if (!empty($data->getFeedback())): ?>
                                <?= nl2br(esc($data->getFeedback())) ?>
                            <?php else: ?>
                                <span class="text-muted fst-italic">Chưa cập nhật</span>
                            <?php endif; ?>
                        </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Bạn có chắc chắn muốn xóa check-out sự kiện của <strong><?= esc($data->getHoTen()) ?></strong> không?
            </div>
