...
use App\Modules\loaisukien\Traits\ExportTrait;
use App\Modules\loaisukien\Traits\RelationTrait;
...
class LoaiSuKien extends BaseController
{
    ...
    protected $moduleUrl;
    protected $title;
    protected $module_name = 'loaisukien';
    protected $controller_name = 'LoaiSuKien';
    ...
    public function exportExcel()
    {
        $keyword = $this->request->getGet('keyword');
        $status = $this->request->getGet('status');
        $sort = $this->request->getGet('sort') ?? 'loai_su_kien_id';
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_loai_su_kien');
    }
    ...
    public function exportPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH LOẠI SỰ KIỆN', 'danh_sach_loai_su_kien');
    }
    ...
    public function exportDeletedPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH LOẠI SỰ KIỆN ĐÃ XÓA', 'danh_sach_loai_su_kien_da_xoa', true);
    }
    ...
    public function exportDeletedExcel()
    {
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_loai_su_kien_da_xoa', true);
    }
