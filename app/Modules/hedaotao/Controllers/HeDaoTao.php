...
use App\Modules\hedaotao\Traits\ExportTrait;
use App\Modules\hedaotao\Traits\RelationTrait;
...
class HeDaoTao extends BaseController
{
    ...
    protected $moduleUrl;
    protected $title;
    protected $module_name = 'hedaotao';
    protected $controller_name = 'HeDaoTao';
    ...
    public function exportExcel()
    {
        $keyword = $this->request->getGet('keyword');
        $status = $this->request->getGet('status');
        $sort = $this->request->getGet('sort') ?? 'he_dao_tao_id';
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_he_dao_tao');
    }
    ...
    public function exportPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH HỆ ĐÀO TẠO', 'danh_sach_he_dao_tao');
    }
    ...
    public function exportDeletedPdf()
    {
        ...
        $this->createPdfFile($data, $filters, 'DANH SÁCH HỆ ĐÀO TẠO ĐÃ XÓA', 'danh_sach_he_dao_tao_da_xoa', true);
    }
    ...
    public function exportDeletedExcel()
    {
        ...
        $this->createExcelFile($data, $headers, $filters, 'danh_sach_he_dao_tao_da_xoa', true);
    }
    ...
    protected function getSortText($sort, $order)
    {
        $sortFields = [
            'he_dao_tao_id' => 'ID',
            'ten_he_dao_tao' => 'Tên hệ đào tạo',
            'ma_he_dao_tao' => 'Mã hệ đào tạo',
            'status' => 'Trạng thái',
            'created_at' => 'Ngày tạo',
