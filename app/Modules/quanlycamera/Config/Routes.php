...
// Cấu hình URL route cho module quanlycamera
$module_name = 'quanlycamera';
$controller_name = 'QuanLyCamera';

// Định nghĩa routes cho module QuanLyCamera
$routes->group($module_name, ['namespace' => 'App\Modules\\' . $module_name . '\Controllers'], 
function ($routes) use ($controller_name) {
    // Route hiển thị danh sách camera
    ...
    // Route cập nhật trạng thái một camera
    $routes->post('status/(:num)', $controller_name . '::status/$1');
    
    // Route xử lý nhiều camera một lúc
