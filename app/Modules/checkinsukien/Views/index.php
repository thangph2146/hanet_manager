...
<?= $this->endSection() ?>
<?= $this->section('title') ?>DANH SÁCH CHECK-IN SỰ KIỆN<?= $this->endSection() ?>
...
<div class="card shadow-sm">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Danh sách check-in sự kiện</h5>
        <div>
                    ...
                    <?php if (isset($_GET['checkin_type']) && $_GET['checkin_type'] !== ''): ?>
                        <span class="badge bg-primary me-2">Loại check-in: 
                            <?php 
                                ...
                                echo $loai_map[$_GET['checkin_type']] ?? $_GET['checkin_type'];
                            ?>
                        </span>
                    <?php endif; ?>
