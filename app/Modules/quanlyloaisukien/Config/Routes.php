...
// Cấu hình URL route cho module quanlyloaisukien
$module_name = 'quanlyloaisukien';
$controller_name = 'QuanLyLoaiSuKien';

// Định nghĩa routes cho module QuanLyLoaiSuKien
$routes->group($module_name, ['namespace' => 'App\Modules\\' . $module_name . '\Controllers'], 
function ($routes) use ($controller_name) {
    // Route hiển thị danh sách loại sự kiện
    ...
    // Route cập nhật trạng thái một loại sự kiện
    $routes->post('status/(:num)', $controller_name . '::status/$1');
    
    // Route xử lý nhiều loại sự kiện một lúc
