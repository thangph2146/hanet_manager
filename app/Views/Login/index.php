...
<head>
	...
	<title>Hệ thống Điểm Danh - Đăng nhập Sinh viên</title>
	<style>
		.page-footer {
			background: #fff;
			left: 0px;
						...
						<div class="card-body">
							<div class="border p-4 rounded">
								<div class="text-center">
									<h3 class="">Hệ thống điểm danh</h3>
									<p>Đăng nhập</p>
								</div>
								<div class="login-separater text-center mb-4"> <span>Sinh viên</span>
									<hr/>
								</div>
								<div class="form-body">
									<?= form_open(site_url("Login/create_student"), ['class' => 'row g-3']) ?>
										...
										<div class="col-md-6 text-end">	<a href="<?= site_url("Password/forgot") ?>">Quên mật khẩu ?</a>
										</div>
										<div class="col-12">
											<div class="d-grid">
