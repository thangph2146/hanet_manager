...
<?= $this->section('title') ?>TẠO SETTING<?= $this->endSection() ?>

<?= $this->section('bread_cum_link') ?>
<!--breadcrumb-->
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
	<div class="breadcrumb-title pe-3">Tạo Setting</div>
	<div class="ps-3">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-0 p-0">
				...
				<li class="breadcrumb-item active" aria-current="page">Tạo Setting</li>
			</ol>
		</nav>
	</div>
	<div class="ms-auto">
		<div class="btn-group">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
				<a class="dropdown-item" href="javascript:;">Tạo Setting</a>
			</div>
		</div>
	</div>
</div>
...
<?= form_open("Settings/create", ['class' => 'row g3']) ?>
	...
	<div class="col-12">
		<button type="submit" class="btn btn-primary">Tạo Setting</button>
	</div>
</form>
<?= $this->endSection() ?>
