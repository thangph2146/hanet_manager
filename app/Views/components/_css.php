...
<link href="<?= site_url('assets/plugins/select2/css/select2-bootstrap4.css') ?>" rel="stylesheet" />
<link href="<?= site_url('assets/plugins/input-tags/css/tagsinput.css') ?>" rel="stylesheet" />
...
<link href="<?= site_url('assets/plugins/highcharts/css/highcharts.css') ?>" rel="stylesheet" />
